...
<div class="card">
    ...
    <div style="text-align: center; padding: 40px 0;">
        ...
        <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
            <a href="{{ route('authors.index') }}" class="btn btn-primary" style="padding: 15px 30px; font-size: 18px;">
                👥 Manage Authors
            </a>
            <a href="{{ route('books.index') }}" class="btn btn-success" style="padding: 15px 30px; font-size: 18px;">
                📖 Manage Books
            </a>
        </div>
    </div>
